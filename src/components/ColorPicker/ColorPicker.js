...
const others = ['#b88b06', '#0b850b','#bd7708','#6c10a1', '#ccc', '#0e739c', '#2a62b0', '#a60798', '#145e02', '#7da148', '#baba29', '#6fba29', '#ba7e29'];
...
const colorPicker = (props) => (
	<div style={popover} className="color-picker border">
		...
		<div className="m-3">
			...
			<hr />
			<CirclePicker colors={props.main ? main : others} onChangeComplete={props.handleChangeComplete} />
			</div>
	</div>
);
